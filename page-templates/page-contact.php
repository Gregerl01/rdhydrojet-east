			...
			<div class="row gy-4 text-center bmg-reveal-stagger">
				...
				<div class="col-6 col-md-3 bmg-reveal">
					<div class="section-contact-trust__item">
						...
						<span class="section-contact-trust__label"><?php esc_html_e( '5.0★ Google Rated', 'bmg-theme' ); ?></span>
						<span class="section-contact-trust__sub"><?php esc_html_e( '300+ Reviews', 'bmg-theme' ); ?></span>
					</div>
				</div>
